...
## 5.17.0 — Payment verification readiness
- Added public merchant-information and policy pages.
- Added public server-controlled pricing before login.
- Added digital service delivery and refund/cancellation disclosures.
- Added public footer, sitemap and robots rules.
- Customer directory now exposes only real connected listener accounts; admin test profiles remain private.
- Bumped customer/employee cache version.
