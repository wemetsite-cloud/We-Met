...
## v8.9.18 verification correction

MSG91's `verifyAccessToken` endpoint is authoritative for successful OTP verification. Depending on Widget/API response shape, MSG91 may return the verified identifier as E.164 digits, national-number digits, or no identifier field at all. v8.9.18 therefore:
